...
namespace Who_Wants_To_Be_A_Millionaire
{
    public partial class MainWindow : Form
    {
        ...
        { 
            ...
            if (btnNextQuestion.Text == "Продължи")
            {
                ...
                {
                    window = new FinalScoreWindow("0. ЛВ0");
                }
            ...
            else if(btnNextQuestion.Text == "Следващ Въпрос" || btnNextQuestion.Text == "ЗАПОЧНИ")
            {
                ...
                btnNextQuestion.Text = "Въпрос " + (questionNo + 1);
            }
